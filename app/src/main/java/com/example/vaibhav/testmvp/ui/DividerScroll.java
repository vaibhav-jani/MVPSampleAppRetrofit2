package com.example.vaibhav.testmvp.ui;
...
public class DividerScroll extends RecyclerView.ItemDecoration {
    ...
    public DividerScroll(Context context, AttributeSet attrs) {
        final TypedArray a = context.obtainStyledAttributes(attrs, new int[]{android.R.attr.listDivider});
        setDivider(a.getDrawable(0));
        a.recycle();
    }

    public static void decorate(RecyclerView recyclerView, int divider, boolean showFirstDivider, boolean showLastDivider) {

        Context context = recyclerView.getContext();

        /*
        Drawable drawable = context.getResources().getDrawable(R.drawable.divider);
        recyclerView.addItemDecoration(new DividerItemDecoration(drawable, context, LinearLayoutManager.VERTICAL));*/


        recyclerView.addItemDecoration(new DividerScroll(ContextCompat.getDrawable(context, divider), showFirstDivider, showLastDivider));
    }
    ...
    @SuppressWarnings("UnusedDeclaration")
    public DividerScroll(Context context, AttributeSet attrs, boolean showFirstDivider,
    ...
    @SuppressWarnings("UnusedDeclaration")
    public DividerScroll(Drawable divider) {
        setDivider(divider);
    }

    @SuppressWarnings("UnusedDeclaration")
    public DividerScroll(Drawable divider, boolean showFirstDivider,
                         boolean showLastDivider) {
        this(divider);
        first = showFirstDivider;
        last = showLastDivider;
